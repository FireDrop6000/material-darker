" Vim Color File
" Name: material-darker.vim
" Maintainer: https://github.com/FireDrop6000/material-darker inspired by https://github.com/kaicataldo/material.vim
...
let s:fg = { 'gui': '#fafafa', 'cterm': 231 }
let s:invisibles = { 'gui': '#4a4a4a', 'cterm': 239 }
let s:comments = { 'gui': '#4a4a4a', 'cterm': 239 }
let s:caret = { 'gui': '#ffcb6b', 'cterm': 222 }
let s:selection = { 'gui': '#262626', 'cterm': 239 }
let s:guides = { 'gui': '#4a4a4a', 'cterm': 239 }
let s:line_numbers = { 'gui': '#4a4a4a', 'cterm': 239 }
let s:line_highlight = { 'gui': '#4a4a4a', 'cterm': 239 }
let s:white = { 'gui': '#fafafa', 'cterm': 231 }
let s:black = { 'gui': '#1c1c1c', 'cterm': 234 }
let s:red = { 'gui': '#f07178', 'cterm': 210 }
let s:orange = { 'gui': '#f78c6c', 'cterm': 209 }
let s:yellow = { 'gui': '#ffcb6b', 'cterm': 222 }
let s:green = { 'gui': '#c3e88d', 'cterm': 156 }
let s:cyan = { 'gui': '#89ddff', 'cterm': 117 }
let s:blue = { 'gui': '#82aaff', 'cterm': 111 }
let s:paleblue = { 'gui': '#b2ccd6', 'cterm': 152 }
let s:purple = { 'gui': '#c792ea', 'cterm': 140 }
let s:brown = { 'gui': '#c17e70', 'cterm': 138 }
let s:pink = { 'gui': '#f07178', 'cterm': 210 }
...
call s:SetHighlight('MatchParen', '', s:comments, 'bold')
...
if g:material_theme_style !~ '-community$'
  ...
  call s:SetHighlight('jsExceptions', s:yellow, '', 'italic')
